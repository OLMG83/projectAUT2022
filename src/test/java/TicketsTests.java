...
public class TicketsTests {
    ...
    public void reservationCheck(){
        ...
        browser.findElement(GO_BTN).click();
            ...
            Assertions.assertTrue(text.startsWith(student.getFirstName()), "Incorrect name!");
            Assertions.assertTrue(secondText.startsWith(student.getFirstName()), "Wrong Name");

     //   Assertions.assertAll(homePageFrom, reservationPageFrom, "Wrong airport!");
